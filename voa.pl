   ...
   {$|=1;
    if(substr($body,0,length($section1)) ne $section1)
     ...
     {$body=substr($body,length($section1));
      ...
      while($body =~ /<li>(.*?)<\/li>/g)
       {if($1 !~ /<a href="\/(Technology_Report|This_is_America|Agriculture_Report|Science_in_the_News|Health_Report|Explorations|Education_Report|The_Making_of_a_Nation|Economics_Report|American_Mosaic|In_the_News|American_Stories|Words_And_Their_Stories|People_in_America|as_it_is|VOA_News)_1[.]html" target="_blank">[[] ([^]]{1,}) []] <\/a> (?:<a href="\/lrc\/([0-9]{6})\/se-([a-z]{2,6})-([^.]{1,})[.]lrc" target=_blank><img src="\/images\/lrc[.]gif" width="27" height="15" border="0"><\/a>){0,1} (?:<a href="\/VOA_Special_English\/([0-9A-Za-z._-]{1,})_1[.]html" target="_blank"><img src="\/images\/yi[.]gif" width="27" height="15" border="0"><\/a> ){0,1}<a href="\/VOA_Special_English\/([0-9A-Za-z._-]{1,}?)([_-]{0,})([0-9]{5})[.]html" target="_blank">([0-9A-Za-z '"+,-:;?‘’“”]{1,})  \([0-9]{4}-[0-9]{1}-([0-9]{1,2})\)<\/a>/)
         {die($1);
         }
        else
